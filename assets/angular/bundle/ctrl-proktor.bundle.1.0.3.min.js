...
angular.module("RdmApp").controller("pengaturanCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer",function(a,e,t,r,l,i,n,o){a.validateToken=function(){$(".rechaptcha-modal").modal("hide");var a=$("#formvalidate");console.log(a.serialize()),$.blockUI({}),o.post("proktor/pengaturan/validaterechaptcha",a.serialize(),(function(a){$.unblockUI({}),null!==a&&a.success?(e.getpengaturan(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):null==a?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Data Gagal Disimpan"}):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:a.message})}))},a.savetahunajaran=function(){$.blockUI({}),o.post("proktor/pengaturan/save",{tahunajaran_id:e.tahunajaran.aktif,semester_id:e.datasemester.aktif,sistem_penilaian:e.penilaian.system,rechapcha:e.rechaptcha.aktif,key:e.rechaptcha.key,secret:e.rechaptcha.secret},(function(a){$.unblockUI({}),null!==a&&a.success?a.validate?($("#rechapthavalidate").html(a.validate),$(".rechaptcha-modal").modal("show")):(e.getpengaturan(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):null==a?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Data Gagal Disimpan"}):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:a.message})}))}}]);
